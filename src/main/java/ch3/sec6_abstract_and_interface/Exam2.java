package ch3.sec6_abstract_and_interface;
...
interface InterfaceTest1 {
    int COUNT = 1;    // 자동으로 public static final 추가됨

    public static final int MAX_SIZE = 10;  // ide에서 중복적인 선언이라고 회색처리됨


    // 접근제한자는 반드시 public !
//    private int a = 10;  //error

//    void method1() {}  //error // body 불가능
    void method2();  // 자동으로 public abstract 추가
    public abstract void  method3(); // ide에서 중복적인 선언이라고 회색처리됨

    // body가 있는 함수 추가
    default void method4() {  // default, static, private만 가능 ! // public 불가능 !
